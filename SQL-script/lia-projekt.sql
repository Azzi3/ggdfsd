...
INSERT INTO `course` (`id`, `name`, `description`, `course_start`, `course_end`) VALUES
...
INSERT INTO `user` (`id`, `email`, `password`, `token`, `firstname`, `lastname`, `course_leader`, `company_owner`, `student`, `municipality`, `online`, `last_activity`, `company_id`, `guid`) VALUES
  (1, 'leader@test.se', 'c5873d32be7b28c098edb8ddfa42de147690c63bc1df3c2dce794b4e0bc3c383c2e8788498e8056a69791dbbfca3942ba7f9ab493e2dfc012fa98f15ef29b639', 'yfXtFb2Ys-', 'Kurs', 'Ledare', 1, 0, 0, 77, 1, '0', 0, '8867d026-ad1e-11e4-b658-0c8bfd7a8af4'),
  (2, 'student@test.se', '3fea32ae712ade481cd2ef4b126f5dc28830fd79fcc4e7bdbd303c08240ab9c46193e6fbb7315d2e242a55a622ffd3c0550d4ae9c7f083a9be85473f7b655ea4', 'JN6z3Gqp7x', 'Vanlig', 'Student', 0, 0, 1, 77, 1, '0', 0, '886c219f-ad1e-11e4-b658-0c8bfd7a8af4'),
  (3, 'company@test.se', 'e4025ff4c1a465a425cc3d96048221732e8d43ccd6556178d9b267866953718f93e535453310c229a183783667da937f53c8e753b76dd969f6fb8c3ba587d193', 'ptrt8HYFkN', 'Företags', 'Ägare', 0, 1, 0, 77, 0, '0', 0, '8870be4c-ad1e-11e4-b658-0c8bfd7a8af4');
...
--
-- AUTO_INCREMENT for table `company_tag`
--
ALTER TABLE `company_tag`
...
--
-- AUTO_INCREMENT for table `lia_project`
--
ALTER TABLE `lia_project`
...
--
-- AUTO_INCREMENT for table `student_tag`
--
ALTER TABLE `student_tag`
