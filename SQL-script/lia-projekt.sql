# Dump of table application_form
# ------------------------------------------------------------
...
INSERT INTO `company` (`id`, `name`, `street_address`, `zip_code`, `city`, `website_url`, `description`, `image`, `id_contact_person`)
VALUES
...
INSERT INTO `contact_person` (`id`, `name`, `email`, `phone`)
VALUES
