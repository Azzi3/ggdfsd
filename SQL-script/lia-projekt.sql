...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 05 feb 2015 kl 11:29
...
--
-- Dumpning av Data i tabell `kommun`
--

INSERT INTO `kommun` (`kommun_id`, `name`, `lan_id`) VALUES
...
--
-- Dumpning av Data i tabell `lan`
--

INSERT INTO `lan` (`lan_id`, `name`) VALUES
(1, 'Blekinge län'),
(2, 'Dalarnas län'),
(3, 'Gotlands län'),
(4, 'Gävleborgs län'),
...
--
-- Index för tabell `kommun`
--
ALTER TABLE `kommun`
 ADD PRIMARY KEY (`kommun_id`);
